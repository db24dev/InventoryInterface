  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white text-black p-6">
      ...
      <div className="text-center max-w-4xl w-full p-10">
        <img className='inline w-20 rounded-full h-20 object-cover border-2 border-black' src="./STOCKEFY.jpg"></img>
